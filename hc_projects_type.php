    ...
    class hc_projects_type_plugin
    {
        ...
        public function register_post_type()
        {
            $labels = [
                ...
                'featured_image' => __('Projekt Hauptbild', ),
                'set_featured_image' => __('Hauptbild einstellen', ),
                'remove_featured_image' => __('Hauptbild entfernen', ),
                'use_featured_image' => __('Als Hauptbild verwenden', ),
                'archives' => __('Projekte', ),
                'insert_into_item' => __('In Projekt einfügen', ),
                'uploaded_to_this_item' => __('Zu diesem Projekt hochgeladen', ),
                'filter_items_list' => __('Liste der Projekte filtern', ),
                'items_list_navigation' => __('Navigation in der Projektliste', ),
                'items_list' => __('Liste der Projekte', ),
            ];
